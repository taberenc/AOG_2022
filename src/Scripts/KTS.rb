...
#  Database Switches
#    [1] ON during night hours   (2300-0400)(11pm-4am)
#    [2] ON during dawn hours    (0500-0700)( 5am-7am)
#    [3] ON during daytime hours (0800-1900)( 8am-7pm)
#    [4] ON during sunset hours  (2000-2200)( 8pm-10pm)
...
module KTS
  ...
  T2 = [ 5,7 ] # Dawn          # [Start Hour, End Hour] for time period
  T3 = [ 8,19] # Day           # Use 24-hour values for time periods
  T4 = [20,22] # Sunset
